...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Track workouts, fuel up, and level up your hero in FitQuest." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "FitQuest — fitness RPG" },
      { name: "twitter:description", content: "Track workouts, fuel up, and level up your hero in FitQuest." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3decf1d1-9bec-482c-833a-776e9122997a/id-preview-b3adcf89--45bc2557-8008-4c5f-b0e1-a2447163ce84.lovable.app-1778696083004.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3decf1d1-9bec-482c-833a-776e9122997a/id-preview-b3adcf89--45bc2557-8008-4c5f-b0e1-a2447163ce84.lovable.app-1778696083004.png" },
